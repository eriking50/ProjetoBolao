...
export class AlteraçãoEnderecoParaTerIdUsuario1636497675800 implements MigrationInterface {
    name = 'AlteraçãoEnderecoParaTerIdUsuario1636497675800'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`usuario\` ADD \`enderecoId\` int NULL DEFAULT 'NULL'`);
