...
export class AdicaoDePontuacaoApostas1636639753303 implements MigrationInterface {
    name = 'AdicaoDePontuacaoApostas1636639753303'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_82bec04bb9fadadad0a33cb0c4\` ON \`endereco\``);
        await queryRunner.query(`ALTER TABLE \`aposta\` ADD \`pontos\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`endereco\` ADD CONSTRAINT \`FK_82bec04bb9fadadad0a33cb0c43\` FOREIGN KEY (\`usuarioId\`) REFERENCES \`usuario\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`aposta\` DROP COLUMN \`pontos\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_82bec04bb9fadadad0a33cb0c4\` ON \`endereco\` (\`usuarioId\`)`);
    }
