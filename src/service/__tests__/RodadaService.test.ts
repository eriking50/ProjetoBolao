...
import { CampeonatoResponse, RodadaResponse, PartidaResponse } from '../../@types/dtos/brasileicaoClientDTO';
...
describe("EnderecoService", () => {
    ...
    let campeonatoResponse: CampeonatoResponse;
    let rodadaResponse: RodadaResponse;
